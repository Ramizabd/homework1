...
df <- data.frame(
  time = seq(2000, 2020, by = 1),   # Time from 2000 to 2020
  population = c(2.5, 2.6, 2.8, 3.0, 3.2, 3.5, 3.8, 4.0, 4.3, 4.5, 4.8, 5.0, 5.3, 5.6, 5.9, 6.1, 6.4, 6.6, 6.8, 7.0, 7.2)  # Sample population values
)
